  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      if (this.state.status === "Welcome") {
        curr_screen = _react2.default.createElement(WelcomeScreen, null);
      } else {
        curr_screen = _react2.default.createElement(Lobby, null);
      }
...
var WelcomeScreen = function (_Component2) {
  _inherits(WelcomeScreen, _Component2);
...
var Lobby = function (_Component3) {
  _inherits(Lobby, _Component3);
...
_reactDom2.default.render(_react2.default.createElement(App, { state: 'Welcome' }), document.getElementById('root'));
